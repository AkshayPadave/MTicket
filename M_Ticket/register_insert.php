...
if(mysqli_query($connect, $sql_userdatabase) == true)
{
	...
	echo '<center><table><tr><td><A href="index.php"><button style="background-color:black; border-color:black"><span style="color:white">Sign in ! </span></button></a></td></tr></table></center>';
}
else
{
