  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        <li><a href="book.php">Train Ticket&nbsp</a></li>
        <li><a href="bookbus.php">Bus Ticket&nbsp</a></li>
        <li><a href="mybookings.php">User Bookings&nbsp</a></li>
        <li><a href="trainschedule.php">Train Schedule&nbsp</a></li>
     </ul>
     <ul class="nav navbar-nav navbar-right">

        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span>&nbsp User : <?php  echo " ". $_SESSION['name'] ."" ?>
