...
<tr>
<td>
<td><a  href="print.php?pid='<?php echo $_SESSION['tno']?>' " target="_blank" ><button style="background-color: black ; border-color:black  "><h3><span style="color:white;"> Print Ticket </span></h3></button></a></td></td>
</td>
</tr>
</body style="background-color: F5F1F0;">
 <?php endwhile; ?>
